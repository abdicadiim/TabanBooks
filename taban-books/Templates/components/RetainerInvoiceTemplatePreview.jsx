...
const RetainerInvoiceTemplatePreview = () => {
  const items = [
    ...
    <div className="bg-white rounded-lg shadow-sm p-8 max-w-2xl mx-auto">
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="text-right">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Retainer Invoice</h1>
          <div className="text-sm text-gray-600">Retainer Invoice# RET-17</div>
          <div className="mt-2">
      ...
      <div className="text-right mb-6 text-sm text-gray-600">
        <div>Invoice Date: 06 Dec 2025</div>
        <div>Due Date: 06 Dec 2025</div>
      </div>
...
export default RetainerInvoiceTemplatePreview;
