    ...
    <div className="bg-white rounded-lg shadow-sm p-8 max-w-2xl mx-auto">
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="text-right">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Bill</h1>
          <div className="text-sm text-gray-600">Bill# BILL-17</div>
          <div className="mt-2">
            <div className="text-sm text-gray-600">Amount Due</div>
            <div className="text-2xl font-bold text-gray-900">$630.00</div>
          </div>
        </div>
      </div>

      <div className="text-right mb-6 text-sm text-gray-600">
        <div>Bill Date: 06 Dec 2025</div>
...
export default BillTemplatePreview;
