...
const PurchaseOrderTemplatePreview = () => {
  const items = [
    ...
    <div className="bg-white rounded-lg shadow-sm p-8 max-w-2xl mx-auto">
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="text-right">
          ...
          <div className="text-sm text-gray-600">Purchase Order# PO-17</div>
        </div>
      </div>
      ...
      <div className="text-right mb-6 text-sm text-gray-600">
        ...
        <div>Expected Delivery Date: 06 Dec 2025</div>
        <div>Ref#: PO-17</div>
      </div>
...
export default PurchaseOrderTemplatePreview;
