...
const VendorPaymentTemplatePreview = () => {
  return (
    <div className="bg-white rounded-lg shadow-sm p-8 max-w-2xl mx-auto">
      <div className="flex justify-between items-start mb-6">
        <CompanyHeader />
        <div className="text-right">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Vendor Payment</h1>
          <div className="text-sm text-gray-600">Payment# VP-17</div>
        </div>
      </div>
      ...
      <div className="mt-6 space-y-2">
        ...
        <div className="flex justify-between text-sm">
          ...
          <span className="text-gray-900 font-semibold">$630.00</span>
        </div>
...
export default VendorPaymentTemplatePreview;
