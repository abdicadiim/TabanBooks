...
const CreditNoteTemplatePreview = () => {
  const items = [
    ...
    <div className="bg-white rounded-lg shadow-sm p-8 max-w-2xl mx-auto">
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="text-right">
          ...
          <div className="text-sm text-gray-600">Credit Note# CN-17</div>
          <div className="mt-2">
      ...
      <div className="text-right mb-6 text-sm text-gray-600">
        <div>Credit Note Date: 06 Dec 2025</div>
        <div>Reference Invoice: INV-17</div>
      </div>
...
export default CreditNoteTemplatePreview;
