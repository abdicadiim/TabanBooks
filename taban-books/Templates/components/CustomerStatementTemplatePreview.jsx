...
const CustomerStatementTemplatePreview = () => {
  const transactions = [
    { date: "01 Dec 2025", description: "Invoice INV-15", debit: 500.00, credit: 0, balance: 500.00 },
    { date: "05 Dec 2025", description: "Payment", debit: 0, credit: 200.00, balance: 300.00 },
    { date: "06 Dec 2025", description: "Invoice INV-17", debit: 662.75, credit: 0, balance: 962.75 },
  ];
    ...
    <div className="bg-white rounded-lg shadow-sm p-8 max-w-2xl mx-auto">
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="text-right">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Customer Statement</h1>
      ...
      <div className="flex justify-end mt-6">
        <div className="w-64 space-y-2 text-sm">
          <div className="flex justify-between font-semibold pt-2 border-t-2 border-gray-400">
            ...
            <span className="text-gray-900">$962.75</span>
          </div>
        </div>
      </div>
    </div>
...
export default CustomerStatementTemplatePreview;
