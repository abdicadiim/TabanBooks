              ...
              <label style={{
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{
                    ...
                    Retains the in Taban Books and does not import the duplicates in the import file.
                  </div>
                </div>
              </label>
              <label style={{
              ...
              style={{
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{
                    ...
                    Imports the duplicates in the import file and overwrites the existing in Taban Books.
                  </div>
                </div>
              </label>
            </div>
          ...
          <button
            ...
            {currentStep < 3 && (
              <button
                ...
                style={{
                  padding: "10px 20px",
                  backgroundColor: (currentStep === 1 && selectedFile) || currentStep === 2 ? "#156372" : "#d1d5db",
                  border: "none",
                  borderRadius: "6px",
                  fontSize: "14px",
                  fontWeight: "500",
                  cursor: (currentStep === 1 && selectedFile) || currentStep === 2 ? "pointer" : "not-allowed",
                  color: "white",
                  display: "flex",
                  alignItems: "center",
                  gap: "4px"
                ...
                onMouseEnter={(e) => {
                  if ((currentStep === 1 && selectedFile) || currentStep === 2) {
