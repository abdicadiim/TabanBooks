...
interface TransactionLockingFindAccountantsSidebarProps {
  open: boolean;
  onClose: () => void;
}

export function TransactionLockingFindAccountantsSidebar({
  open,
  onClose,
}: TransactionLockingFindAccountantsSidebarProps) {
        ...
        >
          <div>
            ...
            <p style={{ margin: "6px 0 0", fontSize: "13px", color: "#64748b" }}>
              Browse finance partners who can help with period-end controls.
            </p>
          </div>
          <button
            type="button"
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "20px", display: "grid", gap: "18px" }}>
          {!selectedAccountant ? (
            <p style={{ margin: 0, fontSize: "14px", lineHeight: 1.7, color: "#64748b" }}>
              Connect with an accountant in your region to design closing workflows,
              review transaction locks, and keep reporting periods under control.
            </p>
          ) : null}
