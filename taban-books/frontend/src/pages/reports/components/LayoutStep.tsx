  ...
  return (
    <div className="p-4">
      ...
      <div className="mt-2 flex flex-col gap-3">
        <div className={card}>
          <div className="mb-2">
            <label className="text-[12px] font-semibold text-slate-600">Report Layout</label>
          </div>
          <select className={combo} value={layout} onChange={(e) => setLayout(e.target.value)}>
        ...
        <div className={card}>
          <div className="mb-2">
            <label className="text-[12px] font-semibold text-slate-600">Totals</label>
          </div>
