...
export default function ImportQuantityAdjustments() {
  ...
  const handleDownloadSample = () => {
    // Sample CSV content for Quantity Adjustments
    const sampleHeaders = [
      "Date",
      "Status",
      "Reference Number",
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Quantity Adjustment - Select File</h1>
          <button
        ...
        <div className="flex justify-between">
          ...
          <button
            onClick={() => {
              if (selectedFile) {
                navigate(`/inventory/import/quantity/map-fields`, { state: { file: selectedFile, characterEncoding, type: 'Quantity' } });
              } else {
