  ...
  return (
    <>
      ...
      <div className={titleClassName}>
        Inventory Adjustment By {adjustment.type}
      </div>
      {journalLines?.length ? (
        ...
        <div className="p-6 text-center text-gray-500 text-sm">
          {isDraft
            ? draftMessage
            : "No journal entry found for this adjustment."}
        </div>
      )}
    </>
  );
...
export function AdjustmentDocumentContent({
  ...
  return (
    <div
      className={`flex-1 min-h-0 overflow-y-auto ${showPdfView ? "bg-[#f4f7fb] p-5 md:p-6" : "bg-white p-5"}`}
    >
      <div
        data-print-content
      ...
      >
        ...
        {showPdfView ? (
          <>
            <h1 className="text-[28px] font-bold text-black m-0 mb-8 text-center">
            ...
            <div className="mb-8">
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-900 font-medium">
                    {getAdjustmentReference(adjustment)}
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <div className="text-sm text-gray-900 font-medium">
                    {renderSafeValue(adjustment.reason)}
                  </div>
                </div>
                <div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="p-4 text-right text-gray-700 font-medium">
                            {Math.abs(details.quantityAdjusted).toFixed(2)}{" "}
                            {details.itemUnit}
                          </td>
                ...
                <table className="w-full border-collapse text-sm border border-gray-200 rounded-md overflow-hidden">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200">
                      <th className="p-3 text-left font-semibold text-xs uppercase text-gray-700">
                        Item Details
                      </th>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <div className="text-xs text-gray-500">
                                  SKU: {details.itemSku || "no"}
                                </div>
                              </div>
                            </div>
                          </td>
                          <td className="p-3 text-right">
                            {Math.abs(details.quantityAdjusted).toFixed(0)}{" "}
                            {details.itemUnit}
                          </td>
                          <td className="p-3 text-right">
                            ${details.rate.toFixed(2)}
