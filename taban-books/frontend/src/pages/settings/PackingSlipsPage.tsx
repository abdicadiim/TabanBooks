...
export default function PackingSlipsPage() {
  ...
  const [documentFields, setDocumentFields] = useState({
    documentTitle: { value: "PACKING SLIP", enabled: true },
    dateField: { value: "Date", enabled: true },
    description: { value: "Description", enabled: true },
    reference: { value: "Reference#", enabled: false },
    billTo: { value: "Bill To", enabled: false },
    deliveryTo: { value: "Delivery To", enabled: false },
    customerNotes: { value: "Show Customer Notes", enabled: true },
    transactionNumber: { value: "#", enabled: true },
    item: { value: "Item", enabled: true },
    quantity: { value: "Qty", enabled: true },
    signature: { value: "Authorized Signature", enabled: false },
    balanceDue: { value: "Balance Due", enabled: false },
  });
  ...
  const updateDocumentField = (fieldName, updates) => {
  ...
  return (
    <div className="p-6 max-w-4xl">
      <h1 className="text-2xl font-semibold text-gray-900 mb-6">Packing Slips</h1>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateDocumentField("documentTitle", { value: e.target.value })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateDocumentField("dateField", { value: e.target.value })}
                  className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateDocumentField("description", { value: e.target.value })}
                  className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="flex items-center gap-3">
                <input
                  type="checkbox"
                  checked={documentFields.reference.enabled}
                ...
                <input
                  ...
                  onChange={(e) => updateDocumentField("reference", { value: e.target.value })}
              ...
              <div className="flex items-center gap-3">
                <input
                  type="checkbox"
                  checked={documentFields.billTo.enabled}
                ...
                <input
                  ...
                  onChange={(e) => updateDocumentField("billTo", { value: e.target.value })}
                  className="flex-1 px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="flex items-center gap-3">
                <input
                  type="checkbox"
                  checked={documentFields.deliveryTo.enabled}
                ...
                <input
                  ...
                  onChange={(e) => updateDocumentField("deliveryTo", { value: e.target.value })}
                  className="flex-1 px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="flex items-center gap-3">
                <input
                  type="checkbox"
                  checked={documentFields.customerNotes.enabled}
                ...
                <input
                  ...
                  onChange={(e) => updateDocumentField("customerNotes", { value: e.target.value })}
                  className="flex-1 px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateDocumentField("transactionNumber", { value: e.target.value })}
                  className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateDocumentField("item", { value: e.target.value })}
                  className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateDocumentField("quantity", { value: e.target.value })}
                  className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="flex items-center gap-3">
                <input
                  type="checkbox"
                  checked={documentFields.signature.enabled}
                ...
                <input
                  ...
                  onChange={(e) => updateDocumentField("signature", { value: e.target.value })}
                  className="flex-1 px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="flex items-center gap-3">
                <input
                  type="checkbox"
                  checked={documentFields.balanceDue.enabled}
                ...
                <input
                  ...
                  onChange={(e) => updateDocumentField("balanceDue", { value: e.target.value })}
                  className="flex-1 px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
            </div>
          ...
          <div className="space-y-4 mb-8">
            <label className={`flex items-start gap-4 p-4 border-2 rounded-lg cursor-pointer transition ${
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Create Packing Slip and perform further actions without approval.
                </p>
              </div>
            </label>
            ...
            <label className={`flex items-start gap-4 p-4 border-2 rounded-lg cursor-pointer transition ${
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Any user with approve permission can approve the Packing Slip.
                </p>
              </div>
            </label>
            ...
            <label className={`flex items-start gap-4 p-4 border-2 rounded-lg cursor-pointer transition ${
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Set many levels of approval. The Packing Slip will be approved only when all the approvers approve.
                </p>
              </div>
            </label>
          </div>
      ...
      {activeTab === "field-customization" && (
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={() => navigate("/settings/packing-slips/new-field")}
      ...
      {activeTab === "related-lists" && (
        <div>
          <div className="flex items-center justify-end mb-6">
            <button
              onClick={() => navigate("/settings/packing-slips/new-related-list")}
              className="px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 flex items-center gap-2"
            >
              <span className="text-lg">+</span>
              New Related List
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">New Custom Button - Packing Slips</h2>
              <button
                onClick={() => {
