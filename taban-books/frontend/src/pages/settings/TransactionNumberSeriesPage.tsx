...
export default function TransactionNumberSeriesPage() {
  ...
  if (showNewSeriesPage) {
    return (
      <div className="flex min-h-full flex-col bg-transparent font-sans">
        <div className="w-full min-w-0 px-0 py-4 md:py-6">
  ...
  return (
    <div className="flex min-h-full min-w-0 flex-col bg-transparent font-sans">
      <div className="w-full min-w-0 px-0 py-4 md:py-6">
        <div className="w-full min-w-0 overflow-hidden rounded-none border-0 bg-transparent shadow-none">
          {/* Top Header */}
          ...
          {/* Horizontal Table */}
          <div className="w-full min-w-0 overflow-x-auto overflow-y-hidden custom-scrollbar">
            <table className="w-full min-w-[1120px] border-collapse whitespace-nowrap border-l border-t border-[#eff2f7] text-left">
              <thead>
