      ...
      <div className="bg-white rounded-lg border border-gray-200 p-12">
        <div className="flex flex-col items-center justify-center py-12">
          ...
          <p className="text-sm text-gray-600 text-center mb-8 max-w-2xl">
            Create Custom Modules to record and track information that cannot be recorded in the pre-defined modules of Taban Books.
          </p>
          <button
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          type="checkbox"
                          checked={useInProducts.tabanBooks}
                          onChange={(e) => setUseInProducts({...useInProducts, tabanBooks: e.target.checked})}
                          className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                        />
                        <span className="text-sm text-gray-700">Taban Books</span>
                        <Info size={14} className="text-gray-400" />
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          type="checkbox"
                          checked={useInProducts.tabanBilling}
                          onChange={(e) => setUseInProducts({...useInProducts, tabanBilling: e.target.checked})}
                          className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                        />
                        <span className="text-sm text-gray-700">Taban Books Billing</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          type="checkbox"
                          checked={useInProducts.tabanExpense}
                          onChange={(e) => setUseInProducts({...useInProducts, tabanExpense: e.target.checked})}
                          className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                        />
                        <span className="text-sm text-gray-700">Taban Books Expense</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          type="checkbox"
                          checked={useInProducts.tabanInventory}
                          onChange={(e) => setUseInProducts({...useInProducts, tabanInventory: e.target.checked})}
                          className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                        />
                        <span className="text-sm text-gray-700">Taban Books Inventory</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          type="checkbox"
                          checked={useInProducts.tabanCommerce}
                          onChange={(e) => setUseInProducts({...useInProducts, tabanCommerce: e.target.checked})}
                          className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                        />
                        <span className="text-sm text-gray-700">Taban Books Commerce</span>
                      </label>
                    </div>
                  </div>
