    ...
    <div className="p-6 max-w-4xl">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
        ...
        <p className="text-sm text-gray-600 mb-2">
          For example, let's say your company's name is Zylker and your website's domain name is https://www.zylker.com. With domain mapping, your customers can access their Customer Portal from the subdomain https://books.zylker.com/portal instead of https://books.tabanbooks.com/portal.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600">
              Taban Books Helpline: 0800601172, 0800211152 (Toll Free)
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 mb-3">
              Have questions regarding custom domains ? Feel free to write to us at support.africa@tabanbooks.com and we'll be glad to assist you.
            </p>
            <button
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900">
                Complete these steps to map your domain in Taban Books
              </h3>
              <button
            ...
            <div className="p-6">
              {currentStep === 1 && (
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Mapping a custom domain to Taban Books lets your customers access their Customer Portal from a custom domain.
                  </p>
                  <p className="text-sm text-gray-600 mb-6">
                    To map a custom domain in Taban Books, you must set up a CNAME record from your domain name provider's website and then verify the ownership of your custom domain name. To get started, click Ok, Got it. <button className="text-blue-600 hover:underline">Learn more</button>
                  </p>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 mb-6">
                    <div className="flex items-center gap-4 mb-4">
                      <input
                        type="text"
                        value="https://books.tabanbooks.com/portal"
                        readOnly
              ...
              <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-200">
                <div className="text-xs text-gray-500">
                  Need Help? <button className="text-blue-600 hover:underline">support@tabanbooks.com</button> and we'll be glad to assist you.
                </div>
              ...
              <div className="mb-6">
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-700">
                    I agree to allow Taban Books to collect the data mentioned above
                  </span>
                </label>
              </div>
