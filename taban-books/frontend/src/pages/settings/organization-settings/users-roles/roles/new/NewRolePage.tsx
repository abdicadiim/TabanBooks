...
type PermissionGroup = Record<string, PermissionFlags>;
type FlatPermissions = Record<string, boolean>;
type ModalState = { isOpen: boolean; type: string };
type ContactModalState = { isOpen: boolean; contactType: "" | "customers" | "vendors" };
type TimesheetPermissionsState = {
  projects: PermissionFlags;
  noExpenses: boolean;
  [key: string]: PermissionFlags | boolean;
};
...
export default function NewRolePage() {
  ...
  const [contactsPermissions, setContactsPermissions] = useState<PermissionGroup>({
    customers: {
      full: false,
      view: true,
      create: true,
  ...
  const [morePermissionsModal, setMorePermissionsModal] = useState<ContactModalState>({
    isOpen: false,
    contactType: ""
  });

  // Items permissions
  const [itemsPermissions, setItemsPermissions] = useState<PermissionGroup>({
  ...
  // Banking permissions
  const [bankingPermissions, setBankingPermissions] = useState<PermissionGroup>({
    banking: {
      full: true,
      view: true,
      create: true,
  ...
  // Sales permissions
  const [salesPermissions, setSalesPermissions] = useState<PermissionGroup>({
    invoices: {
      full: false,
      view: true,
      create: true,
  ...
  const [salesMorePermissionsModal, setSalesMorePermissionsModal] = useState<ModalState>({
    isOpen: false,
    type: ""
  });

  // Purchases permissions
  const [purchasesPermissions, setPurchasesPermissions] = useState<PermissionGroup>({
    bills: {
      full: false,
      view: true,
      create: true,
  ...
  const [purchasesMorePermissionsModal, setPurchasesMorePermissionsModal] = useState<ModalState>({
    isOpen: false,
    type: ""
  });

  // Accountant permissions
  const [accountantPermissions, setAccountantPermissions] = useState<PermissionGroup>({
    chartOfAccounts: {
      full: false,
      view: false,
      create: false,
  ...
  const [accountantMorePermissionsModal, setAccountantMorePermissionsModal] = useState<ModalState>({
    isOpen: false,
    type: ""
  });

  // Timesheets permissions
  const [timesheetsPermissions, setTimesheetsPermissions] = useState<TimesheetPermissionsState>({
    projects: {
      full: false,
      view: true,
      create: false,
  ...
  const [locationsPermissions, setLocationsPermissions] = useState<PermissionGroup>({
  ...
  const [vatFilingPermissions, setVatFilingPermissions] = useState<FlatPermissions>({
  ...
  const [documentsPermissions, setDocumentsPermissions] = useState<FlatPermissions>({
    view: true,
    upload: true,
    delete: true,
    manageFolder: true
  ...
  const [settingsPermissions, setSettingsPermissions] = useState<FlatPermissions>({
  ...
  const [dashboardPermissions, setDashboardPermissions] = useState<FlatPermissions>({
    totalPayables: false,
  ...
  const [businessOverviewPermissions, setBusinessOverviewPermissions] = useState<PermissionGroup>({
  ...
  const [salesReportsPermissions, setSalesReportsPermissions] = useState<PermissionGroup>({
  ...
  const [inventoryPermissions, setInventoryPermissions] = useState<PermissionGroup>({
  ...
  const [inventoryValuationPermissions, setInventoryValuationPermissions] = useState<PermissionGroup>({
  ...
  const [receivablesPermissions, setReceivablesPermissions] = useState<PermissionGroup>({
  ...
  const [paymentsReceivedPermissions, setPaymentsReceivedPermissions] = useState<PermissionGroup>({
  ...
  const [recurringInvoicesPermissions, setRecurringInvoicesPermissions] = useState<PermissionGroup>({
  ...
  const [payablesPermissions, setPayablesPermissions] = useState<PermissionGroup>({
  ...
  const [purchasesAndExpensesPermissions, setPurchasesAndExpensesPermissions] = useState<PermissionGroup>({
  ...
  const [taxesPermissions, setTaxesPermissions] = useState<PermissionGroup>({
  ...
  const [bankingReportsPermissions, setBankingReportsPermissions] = useState<PermissionGroup>({
  ...
  const [projectsAndTimesheetPermissions, setProjectsAndTimesheetPermissions] = useState<PermissionGroup>({
  ...
  const [accountantReportsPermissions, setAccountantReportsPermissions] = useState<PermissionGroup>({
  ...
  const [budgetsPermissions, setBudgetsPermissions] = useState<PermissionGroup>({
    "Budget Vs Actuals": { fullAccess: false, view: false, export: false, schedule: false, share: false }
  });

  // Currency sub-items permissions
  const [currencyPermissions, setCurrencyPermissions] = useState<PermissionGroup>({
  ...
  const [activityPermissions, setActivityPermissions] = useState<PermissionGroup>({
  ...
  const [automationPermissions, setAutomationPermissions] = useState<PermissionGroup>({
  ...
  const handleBusinessOverviewPermission = (reportName: string, permissionType: string) => {
  ...
  const handleSalesReportsPermission = (reportName: string, permissionType: string) => {
  ...
  const handleInventoryPermission = (reportName: string, permissionType: string) => {
  ...
  const handleInventoryValuationPermission = (reportName: string, permissionType: string) => {
  ...
  const handleReceivablesPermission = (reportName: string, permissionType: string) => {
  ...
  const handlePaymentsReceivedPermission = (reportName: string, permissionType: string) => {
  ...
  const handleRecurringInvoicesPermission = (reportName: string, permissionType: string) => {
  ...
  const handlePayablesPermission = (reportName: string, permissionType: string) => {
  ...
  const handlePurchasesAndExpensesPermission = (reportName: string, permissionType: string) => {
  ...
  const handleTaxesPermission = (reportName: string, permissionType: string) => {
  ...
  const handleBankingReportsPermission = (reportName: string, permissionType: string) => {
  ...
  const handleProjectsAndTimesheetPermission = (reportName: string, permissionType: string) => {
  ...
  const handleAccountantReportsPermission = (reportName: string, permissionType: string) => {
  ...
  const handleBudgetsPermission = (reportName: string, permissionType: string) => {
  ...
  const handleCurrencyPermission = (reportName: string, permissionType: string) => {
  ...
  const handleActivityPermission = (reportName: string, permissionType: string) => {
  ...
  const handleAutomationPermission = (reportName: string, permissionType: string) => {
  ...
  const handleSelectAll = (permissionType: string, groupName: string) => {
  ...
  return (
    <div className="p-6 w-full">
      ...
      {morePermissionsModal.isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setMorePermissionsModal({ isOpen: false, contactType: "" })}>
          <div className="bg-white rounded-lg shadow-xl p-6 w-80 relative" onClick={(e) => e.stopPropagation()}>
            <button
              onClick={() => setMorePermissionsModal({ isOpen: false, contactType: "" })}
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  checked={contactsPermissions[morePermissionsModal.contactType]?.syncTabanCRM || false}
                  onChange={(e) => setContactsPermissions({
                    ...contactsPermissions,
                    [morePermissionsModal.contactType]: {
                      ...contactsPermissions[morePermissionsModal.contactType],
                      syncTabanCRM: e.target.checked
                    }
                  })}
                  className="h-4 w-4 accent-blue-600"
                />
                <span className="text-sm text-gray-700">Sync Taban Books CRM</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="checkbox"
      ...
      {salesMorePermissionsModal.isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setSalesMorePermissionsModal({ isOpen: false, type: "" })}>
          <div className="bg-white rounded-lg shadow-xl p-6 w-80 relative" onClick={(e) => e.stopPropagation()}>
            <button
              onClick={() => setSalesMorePermissionsModal({ isOpen: false, type: "" })}
              className="absolute top-4 right-4 text-gray-400 hover:text-gray-600"
            >
              <X size={20} />
            </button>
      ...
      {purchasesMorePermissionsModal.isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setPurchasesMorePermissionsModal({ isOpen: false, type: "" })}>
          <div className="bg-white rounded-lg shadow-xl p-6 w-80 relative" onClick={(e) => e.stopPropagation()}>
            <button
              onClick={() => setPurchasesMorePermissionsModal({ isOpen: false, type: "" })}
              className="absolute top-4 right-4 text-gray-400 hover:text-gray-600"
            >
              <X size={20} />
            </button>
      ...
      {accountantMorePermissionsModal.isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setAccountantMorePermissionsModal({ isOpen: false, type: "" })}>
          <div className="bg-white rounded-lg shadow-xl p-6 w-80 relative" onClick={(e) => e.stopPropagation()}>
            <button
              onClick={() => setAccountantMorePermissionsModal({ isOpen: false, type: "" })}
              className="absolute top-4 right-4 text-gray-400 hover:text-gray-600"
            >
              <X size={20} />
            </button>
