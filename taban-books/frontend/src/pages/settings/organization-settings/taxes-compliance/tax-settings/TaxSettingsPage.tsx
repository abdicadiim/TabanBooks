...
export default function TaxSettingsPage() {
    ...
    useEffect(() => {
        const loadTaxSettings = async () => {
            try {
                ...
                const tax = settings.taxComplianceSettings || {};
    ...
    const handleSave = async () => {
        try {
            ...
            setOrganizationSettings(data?.data?.settings || payload.settings);
    ...
    const handleDisableSalesTax = async () => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/settings/taxes/disable-sales-tax`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            ...
            const data = await response.json();
            if (!response.ok || !data.success) {
                throw new Error(data.message || "Failed to disable sales tax");
            }
            ...
            const updatedSettings = {
                ...organizationSettings,
                taxComplianceSettings: {
                    ...(organizationSettings?.taxComplianceSettings || {}),
                ...
                <div>
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-sm text-gray-600 ml-6">
                            TDS or the Tax Deducted at Source, can be associated with the customers, vendors or both customers and vendors in Taban Books. You can enable TDS for a particular contact in the contact's create or edit page.
                        </p>
                        {enableTDS && (
