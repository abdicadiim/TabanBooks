...
export default function ExportTaxModal({ isOpen, onClose, type = "tax" }) {
  ...
  const [fieldMappings, setFieldMappings] = useState([
    { tabanField: type === "tax-group" ? "Tax Group Name" : "Tax Name", exportField: type === "tax-group" ? "Tax Group Name" : "Tax Name" },
    { tabanField: "Tax Name", exportField: "Tax Name" },
    { tabanField: "Tax Percentage", exportField: "Tax Percentage" }
  ]);
  ...
  const sanitizeFileFormat = (format) => {
    ...
    if (selected === "XLS" || selected === "XLSX") return selected;
    return "CSV";
  };
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      if (!response.ok || !data.success || !Array.isArray(data.data)) {
        throw new Error(data.message || "Failed to load taxes for export");
      }

      const exportRows = buildExportRows(data.data, module);
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, module === "Tax Group" ? "Tax_Group" : "Tax");
      ...
      if (selectedFormat === "CSV") {
        XLSX.writeFile(workbook, `${baseName}_${stamp}.csv`, { bookType: "csv" });
      } else if (selectedFormat === "XLS") {
        XLSX.writeFile(workbook, `${baseName}_${stamp}.xls`, { bookType: "biff8" });
      } else {
        XLSX.writeFile(workbook, `${baseName}_${stamp}.xlsx`, { bookType: "xlsx" });
      }
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="grid grid-cols-2 gap-4 mb-3">
                    <div className="text-sm font-semibold text-gray-700">FIELD NAME IN TABAN BOOKS</div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              newMappings[index].tabanField = e.target.value;
                  ...
                  <button
                    onClick={() => {
                      setFieldMappings([...fieldMappings, { tabanField: "", exportField: "" }]);
                    }}
