...
details = Map();
details.put("quote_number",{"value":quote.get("number"),"isExternal":true,"link":"https://books.tabanbooks.com/app#/quotes/" + quote.get("quote_id")});
details.put("customer_name",{"value":quote.get("customer_name"),"isExternal":true,"link":"https://books.tabanbooks.com/app#/contacts/" + quote.get("customer_id")});
