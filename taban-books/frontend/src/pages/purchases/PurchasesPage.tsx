...
const NewExpenseCustomView = lazy(() => import("./Expense/expenses/NewExpenseCustomView"));
const ImportVendors = lazy(() => import("./vendor/ImportVendors"));
const ImportExpenses = lazy(() => import("./Expense/expenses/ImportExpenses"));
const Expenses = lazy(() => import("./Expense/expenses/Expenses"));
const ExpenseDetail = lazy(() => import("./Expense/expenses/ExpenseDetail"));
const RecordExpense = lazy(() => import("./Expense/expenses/RecordExpense"));
const RecurringExpenses = lazy(() => import("./Expense/expenses/RecurringExpenses"));
const NewRecurringExpense = lazy(() => import("./Expense/expenses/NewRecurringExpense"));
const RecurringExpenseDetail = lazy(() => import("./Expense/expenses/RecurringExpenseDetail"));
const ImportRecurringExpenses = lazy(() => import("./Expense/expenses/ImportRecurringExpenses"));
