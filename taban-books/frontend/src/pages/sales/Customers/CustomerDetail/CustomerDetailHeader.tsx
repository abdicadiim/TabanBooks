...
export default function CustomerDetailHeader(args: any) {
  ...
  const hasPreloadedNewTransactionRoutes = useRef(false);

  const preloadNewTransactionRoutes = () => {
    if (hasPreloadedNewTransactionRoutes.current) return;
    hasPreloadedNewTransactionRoutes.current = true;

    void Promise.all([
      import("../../Invoices/InvoicesRoutes"),
      import("../../Quotes/QuotesRoutes"),
      import("../../CreditNotes/CreditNotesRoutes"),
      import("../../SalesReceipts/SalesReceiptsRoutes"),
      import("../../PaymentsReceived/PaymentsReceivedRoutes"),
      import("../../RetainerInvoice/RetainerInvoiceRoutes"),
    ]);
  };
  ...
  return (
    <div className="sticky top-0 z-30 bg-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative inline-flex" ref={newTransactionDropdownRef}>
              ...
              <button
                  ...
                  onMouseEnter={preloadNewTransactionRoutes}
                  onFocus={preloadNewTransactionRoutes}
                  onClick={() => {
                    preloadNewTransactionRoutes();
                    setIsNewTransactionDropdownOpen(!isNewTransactionDropdownOpen);
                  }}
                >
                  <Plus size={16} />
                  New Transaction
              ...
              {isNewTransactionDropdownOpen && (
                <div className="absolute right-0 top-full z-50 mt-2 w-56 rounded-lg border border-gray-200 bg-white shadow-lg">
                  ...
                  <div className="cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-50" onClick={() => { setIsNewTransactionDropdownOpen(false); navigate("/sales/invoices/new", { state: { customerId, customerName, customer } }); }}>Invoice</div>
                  <div className="cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-50" onClick={() => { setIsNewTransactionDropdownOpen(false); navigate("/sales/payments-received/new", { state: { customerId, customerName, customer } }); }}>Customer Payment</div>
                  <div className="cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-50" onClick={() => { setIsNewTransactionDropdownOpen(false); navigate("/sales/payment-links", { state: { customerId, customerName, customer } }); }}>Payment Link</div>
                  <div className="cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-50" onClick={() => { setIsNewTransactionDropdownOpen(false); navigate("/sales/quotes/new", { state: { customerId, customerName, customer } }); }}>Quote</div>
                  <div className="cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-50" onClick={() => { setIsNewTransactionDropdownOpen(false); navigate("/sales/retainer-invoices/new", { state: { customerId, customerName, customer } }); }}>Retainer Invoice</div>
                  <div className="cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-50" onClick={() => { setIsNewTransactionDropdownOpen(false); navigate("/sales/credit-notes/new", { state: { customerId, customerName, customer } }); }}>Credit Note</div>
                  <div className="cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-50" onClick={() => { setIsNewTransactionDropdownOpen(false); navigate("/sales/sales-receipts/new", { state: { customerId, customerName, customer } }); }}>Sales Receipt</div>
                  <div className="cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-50" onClick={() => { setIsNewTransactionDropdownOpen(false); navigate("/time-tracking/projects/new", { state: { customerId, customerName, customer } }); }}>Project</div>
                </div>
              )}
            </div>
      ...
      <div className="mb-0 flex gap-6 border-b border-gray-200 bg-white px-1">
        ...
        <button
          className={`-mb-px cursor-pointer border-b-2 px-2.5 py-3 text-[13px] font-bold transition-colors ${activeTab === "sales" ? "border-[#156372] text-gray-900" : "border-transparent text-gray-500 hover:text-gray-900"}`}
          onClick={() => {
            setActiveTab("sales");
        ...
        {customer?.linkedVendorId && (
          <button
            className={`-mb-px cursor-pointer border-b-2 px-2.5 py-3 text-[13px] font-bold transition-colors ${activeTab === "purchases" ? "border-[#156372] text-gray-900" : "border-transparent text-gray-500 hover:text-gray-900"}`}
