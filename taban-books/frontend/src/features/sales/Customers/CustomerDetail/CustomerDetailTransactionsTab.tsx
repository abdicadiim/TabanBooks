  ...
  return (
                        <div className="flex-1 min-h-0 p-6" style={{ paddingRight: 0 }}>
                            ...
                            <div className="space-y-0">
                                                    ...
                                                    <tbody>
                                                        {(bills || []).length > 0 ? (
                                                            (bills || []).map((bill: any) => (
                                                                ...
                                                                >
                                                                    <td className="py-3 px-4 text-gray-900">
                                                                        {new Date(String(bill.billDate || bill.date || bill.createdAt || 0)).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}
                                                                    </td>
                                                                    <td className="py-3 px-4 text-blue-600 font-medium">
                                                                        {bill.billNumber || bill.id}
                                                                    </td>
                                                                    <td className="py-3 px-4 text-gray-900">{bill.referenceNumber || "-"}</td>
                                                                    ...
                                                                    <td className="py-3 px-4">
                                                                        <span className={`px-2 py-1 rounded-full text-[11px] font-medium uppercase ${(bill.status || "").toLowerCase() === "paid" ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-700"}`}>
                                                                            {bill.status || "Open"}
                                                                        </span>
                                                                    </td>
                                                                </tr>
                                ...
                                <>
                                    <div className={`flex items-center justify-between py-3 px-4 border-b border-gray-200 hover:bg-gray-50 transition-colors ${expandedTransactions.purchaseOrders ? "bg-blue-50 border-l-4 border-l-blue-600" : ""}`}>
                                        <div
                                            className="flex items-center gap-3 flex-1 cursor-pointer"
                                            ...
                                            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                                                <table className="w-full border-collapse text-[13px]">
                                                    <thead>
                                                        <tr className="bg-gray-50 border-b border-gray-200">
                                                            <th className="py-3 px-4 text-left font-medium text-gray-600 text-xs uppercase tracking-wider">DATE</th>
                                                            <th className="py-3 px-4 text-left font-medium text-gray-600 text-xs uppercase tracking-wider">PO#</th>
                                                            <th className="py-3 px-4 text-left font-medium text-gray-600 text-xs uppercase tracking-wider">REFERENCE#</th>
                                                            <th className="py-3 px-4 text-left font-medium text-gray-600 text-xs uppercase tracking-wider">AMOUNT</th>
                                                            <th className="py-3 px-4 text-left font-medium text-gray-600 text-xs uppercase tracking-wider">STATUS</th>
                                                        </tr>
                                                    ...
                                                    <tbody>
                                                        {(purchaseOrders || []).length > 0 ? (
                                                            (purchaseOrders || []).map((po: any) => (
                                                                ...
                                                                >
                                                                    <td className="py-3 px-4 text-gray-900">
                                                                        {new Date(String(po.date || po.createdAt || 0)).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}
                                                                    </td>
                                                                    <td className="py-3 px-4 text-blue-600 font-medium">
                                                                        {po.purchaseOrderNumber || po.id}
                                                                    </td>
                                                                    <td className="py-3 px-4 text-gray-900">{po.referenceNumber || "-"}</td>
                                                                    <td className="py-3 px-4 text-gray-900 font-medium">{formatCurrency(po.total || 0, po.currency || customer?.currency || "AMD")}</td>
                                                                    <td className="py-3 px-4">
                                                                        <span className={`px-2 py-1 rounded-full text-[11px] font-medium uppercase ${(po.status || "").toLowerCase() === "issued" ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-700"}`}>
                                                                            {po.status || "Draft"}
                                                                        </span>
                                                                    </td>
                                                                </tr>
                                ...
                                <>
                                    <div className={`flex items-center justify-between py-3 px-4 border-b border-gray-200 hover:bg-gray-50 transition-colors ${expandedTransactions.vendorPayments ? "bg-blue-50 border-l-4 border-l-blue-600" : ""}`}>
                                        <div
                                            className="flex items-center gap-3 flex-1 cursor-pointer"
                                            onClick={() => toggleTransactionSection("vendorPayments")}
                                        >
                                            {expandedTransactions.vendorPayments ? (
                                                <ChevronDown size={16} className="text-gray-400" />
                                            ) : (
                                                <ChevronRight size={16} className="text-gray-400" />
                                            )}
                                            <span className="text-sm font-medium text-gray-900">Vendor Payments</span>
                                        </div>
                                    </div>
                                    {expandedTransactions.vendorPayments && (
                                        <div className="p-4 bg-white border-b border-gray-200">
                                                ...
                                                <table className="w-full border-collapse text-[13px]">
                                                    ...
                                                    <tbody>
                                                        {(paymentsMade || []).length > 0 ? (
                                                            (paymentsMade || []).map((pm: any) => (
                                                                <tr
                                                                    key={pm.id}
                                                                    onClick={() => navigate(`/purchases/payments-made/${pm.id}`)}
                                                                    className="border-b border-gray-200 transition-colors cursor-pointer hover:bg-gray-50"
                                                                >
                                                                    <td className="py-3 px-4 text-gray-900">
                                                                        {new Date(String(pm.paymentDate || pm.date || 0)).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}
                                                                    </td>
                                                                    <td className="py-3 px-4 text-blue-600 font-medium">
                                                                        {pm.paymentNumber || pm.id}
                                                                    </td>
                                                                    <td className="py-3 px-4 text-gray-900">{pm.referenceNumber || "-"}</td>
                                                                    <td className="py-3 px-4 text-gray-900">{pm.billNumber || "-"}</td>
                                                                    <td className="py-3 px-4 text-gray-900 font-medium">{formatCurrency(pm.amount || 0, pm.currency || customer?.currency || "AMD")}</td>
                                                                </tr>
                                                            ))
                                                        ) : (
                                                            <tr>
                                                                <td colSpan={5} className="py-8 px-4 text-center text-sm text-gray-500">
                                                                    There are no vendor payments.
                                                                </td>
                                                            </tr>
                                                        )}
                                                    </tbody>
                                ...
                                <>
                                    <div className={`flex items-center justify-between py-3 px-4 border-b border-gray-200 hover:bg-gray-50 transition-colors ${expandedTransactions.vendorCredits ? "bg-blue-50 border-l-4 border-l-blue-600" : ""}`}>
                                        <div
                                            className="flex items-center gap-3 flex-1 cursor-pointer"
                                        ...
                                        >
                                            ...
                                            <span className="text-sm font-medium text-gray-900">Vendor Credits</span>
                                        </div>
                                    </div>
                                    {expandedTransactions.vendorCredits && (
                                        <div className="p-4 bg-white border-b border-gray-200">
                                            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                                                <table className="w-full border-collapse text-[13px]">
                                                    <thead>
                                                        <tr className="bg-gray-50 border-b border-gray-200">
                                                            <th className="py-3 px-4 text-left font-medium text-gray-600 text-xs uppercase tracking-wider">DATE</th>
                                                            <th className="py-3 px-4 text-left font-medium text-gray-600 text-xs uppercase tracking-wider">CREDIT#</th>
                                                            <th className="py-3 px-4 text-left font-medium text-gray-600 text-xs uppercase tracking-wider">REFERENCE#</th>
                                                            <th className="py-3 px-4 text-left font-medium text-gray-600 text-xs uppercase tracking-wider">AMOUNT</th>
                                                            <th className="py-3 px-4 text-left font-medium text-gray-600 text-xs uppercase tracking-wider">BALANCE</th>
                                                        </tr>
                                                    ...
                                                    <tbody>
                                                        {(vendorCredits || []).length > 0 ? (
                                                            (vendorCredits || []).map((vc: any) => (
                                                                <tr
                                                                    key={vc.id}
                                                                    onClick={() => navigate(`/purchases/vendor-credits/${vc.id}`)}
                                                                    className="border-b border-gray-200 transition-colors cursor-pointer hover:bg-gray-50"
                                                                >
                                                                    <td className="py-3 px-4 text-gray-900">
                                                                        {new Date(String(vc.date || 0)).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}
                                                                    </td>
                                                                    <td className="py-3 px-4 text-blue-600 font-medium">
                                                                        {vc.vendorCreditNumber || vc.id}
                                                                    </td>
                                                                    <td className="py-3 px-4 text-gray-900">{vc.referenceNumber || "-"}</td>
                                                                    <td className="py-3 px-4 text-gray-900 font-medium">{formatCurrency(vc.total || 0, vc.currency || customer?.currency || "AMD")}</td>
                                                                    <td className="py-3 px-4 text-gray-900">{formatCurrency(vc.balance || 0, vc.currency || customer?.currency || "AMD")}</td>
                                                                </tr>
                                                            ))
                                                        ) : (
                                                            <tr>
                                                    ...
                                                    <tbody>
                                                        {(journals || []).length > 0 ? (
                                                            (journals || []).map((journal: any) => (
                                                                ...
                                                                >
                                                                    <td className="py-3 px-4 text-gray-900">
                                                                        {new Date(String(journal.date || 0)).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}
                                                                    </td>
                                                                    <td className="py-3 px-4 text-blue-600 font-medium">
                                                                    ...
                                                                    <td className="py-3 px-4 text-gray-900 font-medium">{formatCurrency(journal.total || 0, journal.currency || customer?.currency || "AMD")}</td>
                                                                </tr>
                                                            ))
                                                        ) : (
                                                            <tr>
