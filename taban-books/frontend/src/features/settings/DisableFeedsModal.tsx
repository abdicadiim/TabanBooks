                ...
                <div className="p-8">
                    <div className="flex gap-4 items-start">
                        <div className="flex-shrink-0">
                            <img src="/warning-icon.png" alt="Warning" className="w-12 h-12" onError={(e) => {
                                // Fallback if image doesn't exist, though user screenshot shows an image. 
                                // Using Lucide icon as a robust fallback or primary if no asset available.
