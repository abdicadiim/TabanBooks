...
function ImportJournals() {
  ...
  const [autoGenerateJournalNumbers, setAutoGenerateJournalNumbers] = useState(false);
        ...
        <div style={{ padding: "24px" }}>
          ...
          <div style={{ marginBottom: "24px" }}>
            <label style={{ display: "flex", alignItems: "flex-start", gap: "10px", cursor: "pointer" }}>
              <input
                type="checkbox"
                checked={autoGenerateJournalNumbers}
                onChange={(e) => setAutoGenerateJournalNumbers(e.target.checked)}
                style={{
                  marginTop: "2px",
                  width: "16px",
                  height: "16px",
              ...
              <div>
                ...
                <div style={{ fontSize: "12px", color: "#6b7280", lineHeight: "1.5" }}>
                  Journal numbers will be generated automatically according to your settings. Any Journal numbers in the import file will be ignored.
                </div>
              </div>
            </label>
          </div>
            ...
            <button
              onClick={() => {
                ...
                if (selectedFile) {
                  ...
                  // navigate("/accountant/manual-journals/import/map-fields");
                }
              }}
