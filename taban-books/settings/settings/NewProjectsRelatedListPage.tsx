...
details = Map();
details.put("project_name",{"value":project.get("name"),"isExternal":true,"link":"https://books.zoho.com/app#/projects/" + project.get("project_id")});
details.put("customer_name",{"value":project.get("customer_name"),"isExternal":true,"link":"https://books.zoho.com/app#/contacts/" + project.get("customer_id")});
