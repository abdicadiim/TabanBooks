...
import { Lock, ChevronDown, Plus, GripVertical, X, Edit2, Sparkles } from "lucide-react";
...
export default function BillsPage() {
  ...
  const [customFields, setCustomFields] = useState([
    { name: "Bill#", dataType: "Text Box (Single Line)", mandatory: "Yes", showInAllPDFs: "Yes", status: "Active", locked: false, link: true },
    { name: "Bill Date", dataType: "Date", mandatory: "Yes", showInAllPDFs: "Yes", status: "Active", locked: false, link: true },
    { name: "Description", dataType: "Text Box (Single Line)", mandatory: "No", showInAllPDFs: "Yes", status: "Inactive", locked: true },
    { name: "Notes", dataType: "Text Box (Multi-line)", mandatory: "No", showInAllPDFs: "No", status: "Active", locked: true }
  ]);
  const customFieldsUsage = customFields.filter(f => !f.locked).length;
  const maxCustomFields = 59;
  
  // Validation Rules tab states
    ...
    <div className="p-6 max-w-4xl">
      ...
      {activeTab === "field-customization" && (
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={() => navigate("/settings/bills/new-field")}
      ...
      {activeTab === "related-lists" && (
        <div>
          <div className="flex items-center justify-end mb-6">
            <button
              onClick={() => navigate("/settings/bills/new-related-list")}
              className="px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 flex items-center gap-2"
            >
              <span className="text-lg">+</span>
              New Related List
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">New Custom Button - Bills</h2>
              <button
                onClick={() => {
