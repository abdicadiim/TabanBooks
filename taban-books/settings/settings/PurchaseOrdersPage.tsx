...
export default function PurchaseOrdersPage() {
  ...
  // General tab states
  const [closeWhenOption, setCloseWhenOption] = useState("when-bill-created");
  ...
  return (
    <div className="p-6 max-w-4xl">
      <h1 className="text-2xl font-semibold text-gray-900 mb-6">Purchase Orders</h1>
          ...
          <div className="space-y-4 mb-8">
            <label className={`flex items-start gap-4 p-4 border-2 rounded-lg cursor-pointer transition ${
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Create Purchase Order and perform further actions without approval.
                </p>
              </div>
            </label>
            ...
            <label className={`flex items-start gap-4 p-4 border-2 rounded-lg cursor-pointer transition ${
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Any user with approve permission can approve the Purchase Order.
                </p>
              </div>
            </label>
            ...
            <label className={`flex items-start gap-4 p-4 border-2 rounded-lg cursor-pointer transition ${
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Set many levels of approval. The Purchase Order will be approved only when all the approvers approve.
                </p>
              </div>
            </label>
          </div>
      ...
      {activeTab === "field-customization" && (
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={() => navigate("/settings/purchase-orders/new-field")}
      ...
      {activeTab === "related-lists" && (
        <div>
          <div className="flex items-center justify-end mb-6">
            <button
              onClick={() => navigate("/settings/purchase-orders/new-related-list")}
              className="px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 flex items-center gap-2"
            >
              <span className="text-lg">+</span>
              New Related List
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">New Custom Button - Purchase Orders</h2>
              <button
                onClick={() => {
