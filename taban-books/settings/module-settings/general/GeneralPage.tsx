      ...
      <div className="rounded-lg border-0">
        ...
        <div className="border-t border-gray-200 px-6 pt-6">
          <div className="flex items-center gap-2 mb-3">
            <h3 className="text-sm font-semibold text-gray-900">Taban Books Inventory Add-on</h3>
            <Info size={14} className="text-gray-400" />
          ...
          <label className="flex items-center gap-2 cursor-pointer mb-3">
            <input
              ...
              className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
            />
            <span className="text-sm text-gray-700">Enable Taban Books Inventory modules in Taban Books.</span>
          </label>
          {enableInventory && (
            <div className="ml-6">
              <p className="text-sm text-gray-600 mb-2">
                Enabling Taban Books Inventory Add-on will allow you to use the following modules of Taban Books Inventory within Taban Books:
              </p>
        ...
        <div className="border-t border-gray-200 px-6 pt-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-6 gap-2 items-center">
              ...
              <button type="button" className="h-9 px-3 text-sm rounded-lg border border-gray-300 bg-gray-50 hover:bg-gray-100 text-gray-700 font-medium">ORIGINAL</button>
              <button type="button" className="h-9 px-3 text-sm rounded-lg border border-gray-300 bg-gray-50 hover:bg-gray-100 text-gray-700 font-medium">DUPLICATE</button>
              <div></div>
              <div></div>
              <div></div>
            </div>
            ...
            <div className="grid grid-cols-6 gap-2 items-center">
              ...
              <button type="button" className="h-9 px-3 text-sm rounded-lg border border-gray-300 bg-gray-50 hover:bg-gray-100 text-gray-700 font-medium">ORIGINAL</button>
              <button type="button" className="h-9 px-3 text-sm rounded-lg border border-gray-300 bg-gray-50 hover:bg-gray-100 text-gray-700 font-medium">DUPLICATE</button>
              <button type="button" className="h-9 px-3 text-sm rounded-lg border border-gray-300 bg-gray-50 hover:bg-gray-100 text-gray-700 font-medium">TRIPLICATE</button>
              <div></div>
              <div></div>
            </div>
            ...
            <div className="grid grid-cols-6 gap-2 items-center">
              ...
              <button type="button" className="h-9 px-3 text-sm rounded-lg border border-gray-300 bg-gray-50 hover:bg-gray-100 text-gray-700 font-medium">DUPLICATE</button>
              <button type="button" className="h-9 px-3 text-sm rounded-lg border border-gray-300 bg-gray-50 hover:bg-gray-100 text-gray-700 font-medium">TRIPLICATE</button>
              <button type="button" className="h-9 px-3 text-sm rounded-lg border border-gray-300 bg-gray-50 hover:bg-gray-100 text-gray-700 font-medium">QUADRUPLICA</button>
              <button type="button" className="h-9 px-3 text-sm rounded-lg border border-gray-300 bg-gray-50 hover:bg-gray-100 text-gray-700 font-medium">QUINTUPLICAT</button>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 px-6 pt-6">
          <div className="flex items-center justify-between">
            ...
            >
              <span className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform ${paymentRetention ? 'translate-x-6' : 'translate-x-0'}`} />
            </button>
          </div>
        </div>
        ...
        <div id="organization-address-format" className="border-t border-gray-200 px-6 pt-6">
          <h3 className="text-sm font-semibold text-gray-900 mb-3">Organization Address Format</h3>
          <textarea
        ...
        <div className="flex items-center justify-end px-6 pt-6 border-t border-gray-200">
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex items-center gap-2 px-6 py-2.5 text-sm font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-700 disabled:opacity-50 shadow-lg"
          >
