...
export default function DeliveryNotesPage() {
  ...
  const [documentFields, setDocumentFields] = useState({
    documentTitle: { value: "DELIVERY NOTE", enabled: true },
    dateField: { value: "Date", enabled: true },
    description: { value: "Description", enabled: true },
    reference: { value: "Reference#", enabled: true },
    billTo: { value: "Bill To", enabled: true },
    deliveryTo: { value: "Delivery To", enabled: true },
    ...
    signature: { value: "Authorized Signature", enabled: true },
    balanceDue: { value: "Balance Due", enabled: true },
  });
          ...
          <div className="space-y-4 mb-8">
            <label className={`flex items-start gap-4 p-4 border-2 rounded-lg cursor-pointer transition ${
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Create Delivery Note and perform further actions without approval.
                </p>
              </div>
            </label>
            ...
            <label className={`flex items-start gap-4 p-4 border-2 rounded-lg cursor-pointer transition ${
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Any user with approve permission can approve the Delivery Note.
                </p>
              </div>
            </label>
            ...
            <label className={`flex items-start gap-4 p-4 border-2 rounded-lg cursor-pointer transition ${
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Set many levels of approval. The Delivery Note will be approved only when all the approvers approve.
                </p>
              </div>
            </label>
          </div>
      ...
      {activeTab === "field-customization" && (
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={() => navigate("/settings/delivery-notes/new-field")}
      ...
      {activeTab === "related-lists" && (
        <div>
          <div className="flex items-center justify-end mb-6">
            <button
              onClick={() => navigate("/settings/delivery-notes/new-related-list")}
              className="px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 flex items-center gap-2"
            >
              <span className="text-lg">+</span>
              New Related List
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">New Custom Button - Delivery Notes</h2>
              <button
                onClick={() => {
