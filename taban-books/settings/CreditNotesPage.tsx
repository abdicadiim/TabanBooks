...
export default function CreditNotesPage() {
  ...
  // General tab states
  const [allowOverrideCostPrices, setAllowOverrideCostPrices] = useState(false);
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-8">
          ...
          <div className="border-t border-gray-200 pt-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-sm font-semibold text-gray-900 mb-2">Credit Note QR Code</h3>
                <p className="text-sm text-gray-600">
                  Configure a QR code for PDF copies of Credit Notes. Your customers can scan the QR code to access a URL or other information.
                </p>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-sm text-gray-600">{qrCodeEnabled ? "Enabled" : "Disabled"}</span>
                <button
      ...
      {activeTab === "field-customization" && (
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={() => navigate("/settings/credit-notes/new-field")}
      ...
      {activeTab === "related-lists" && (
        <div>
          <div className="flex items-center justify-end mb-6">
            <button
              onClick={() => navigate("/settings/credit-notes/new-related-list")}
              className="px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 flex items-center gap-2"
            >
              <span className="text-lg">+</span>
              New Related List
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">New Custom Button - Credit Notes</h2>
              <button
                onClick={() => {
